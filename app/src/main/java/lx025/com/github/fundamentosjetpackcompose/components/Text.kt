package lx025.com.github.fundamentosjetpackcompose.components
...
import lx025.com.github.fundamentosjetpackcompose.R
...
fun DifferentFont() {
    ...
    Column {
        ...
        Text(
            text = "Edu NSWACT Cursive regular",
            fontFamily = fontFamilyEDU,
            fontWeight = FontWeight.Normal
        )
        Text(
            text = "Edu NSWACT Cursive medium",
            fontFamily = fontFamilyEDU,
